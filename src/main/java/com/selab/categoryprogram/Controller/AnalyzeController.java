...
public class AnalyzeController {
    ...
    public void exportCDMSInfo(HttpServletResponse response) throws IOException {
        ...
        String[] csvHeader = {"id", "new_code", "category", "type", "comis_id", "_class", "meta_version", "meta_last_version", "product_version", "product_version_start_date", "product_version_end_date", "product_id", "product_name_kr", "product_name_en", "product_group", "product_desc", "qc_info", "timezone_filename", "timezone_contents", "pattern", "contents_type", "product_level_main", "product_level_sub", "operation_start_date", "operation_finish_date", "service_ip", "dir_path", "date_path", "api_list", "default_api", "file_extension", "compress_method", "file_format", "binary_info", "ascii_info", "number_of_columns", "columns", "number_of_index", "indexes", "ddl_script", "db_name", "table_name", "user_id", "meta_manager", "product_origin", "product_system", "product_lang", "meta_lang", "meta_charset", "test_start_date", "test_finish_date"};
